 ...
 * @author Mihai Serban
 */
public final class VirtualBoxControlV52 implements VirtualBoxControl {
    ...
    public VirtualBoxControlV52(final String hostUrl, final String userName, final Secret password) {
